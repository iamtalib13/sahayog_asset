...
scheduler_events = {
    ...
    "all": ["sahayog_asset.tasks.all"],
    "daily": ["sahayog_asset.tasks.daily"],
    "hourly": ["sahayog_asset.tasks.hourly"],
    "weekly": ["sahayog_asset.tasks.weekly"],
    "monthly": ["sahayog_asset.tasks.monthly"],
}
